...
public class AmazonStepdefinitions {
    ...
    @And("cikan urunlerden {string} kelimesi icerenlerin fiyat ortalamasinin {int} altinda oldugunu test eder")
    public void cikanUrunlerdenKelimesiIcerenlerinFiyatOrtalamasininAltindaOldugunuTestEder(String arananurun, int ortalamafiyat) {
